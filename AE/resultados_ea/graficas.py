...
graficas.py
-----------
Genera gráficas de convergencia EA a partir de los CSV producidos por Processing.
...
def plot_single(config_name, subfolder):
    ...
    fig.suptitle(f"AE – {config_name}  ({n_runs} ejecuciones)",
                 fontsize=13, y=1.01)
...
def plot_comparison(all_means):
    ...
    fig, (ax_lin, ax_log) = plt.subplots(1, 2, figsize=(14, 5.5))
    fig.suptitle("Comparación configuraciones AE – mejor fitness (media 30 runs)",
                 fontsize=12, y=1.01)
